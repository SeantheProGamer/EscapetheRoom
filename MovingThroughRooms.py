def room():
    ...
    while room < 4:    
        ...
        while room == 2:   
            print "You are now on the stairs."
            action2 = input("Choose. (To the north is a door. 5 paintings grace the walls, each with a rusty name plate and a description. Seth: A handsome boy. Kevin: Cries himself to slept every night. Sean: Timid individual. Dylan: The best teacher. McDonough: A vile toadstool who isn't particularly good at teaching.)")
            if action2 == "north":
                if key == 2:
                    room = 3
                else:
        ...
        while room == 3:   
            ...
            if action3 = "east"
                room = 4
                while room == 4:
                    print "Your in a bathroom. Oh god, your drowning in rust."
            else:
